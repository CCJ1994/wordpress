          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                <h2><?php the_title();?></h2>
                <p><?php $excerpt = get_the_excerpt(); echo esc_html( education_insight_string_limit_words( $excerpt, 25 )); ?></p>
                ...
                <?php  while ( $query->have_posts() ) : $query->the_post(); ?>
                  <div class="col-lg-3 col-md-6 pl-lg-0 pl-md-0">
                    <div class="<?php echo('mid-inner-box').$education_insight_s ?>">
                      ...
                      <p><?php $excerpt = get_the_excerpt(); echo esc_html( education_insight_string_limit_words( $excerpt, 8 )); ?></p>
                    </div>
                  </div>
    ...
    <section id="course-cat">
      <div class="container">
        <div class="row">
          ...
          $page_query = new WP_Query(array( 'category_name' => esc_html($catData1 ,'education-academy-coach')));?>
